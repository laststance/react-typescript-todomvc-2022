...
test('should click toggle-all-button, then all item being comlete checked true and vice versa', () => {
  ...
  expect((getAllByTestId('todo-item-complete-checkbox')[0] as HTMLInputElement).checked).toBe(true) /* eslint-disable-line prettier/prettier */
  expect((getAllByTestId('todo-item-complete-checkbox')[1] as HTMLInputElement).checked).toBe(true) /* eslint-disable-line prettier/prettier */
  expect((getAllByTestId('todo-item-complete-checkbox')[2] as HTMLInputElement).checked).toBe(true) /* eslint-disable-line prettier/prettier */

  // toggle off
  fireEvent.click(getByTestId('toggle-all-btn'))
  expect((getAllByTestId('todo-item-complete-checkbox')[0] as HTMLInputElement).checked).toBe(false) /* eslint-disable-line prettier/prettier */
  expect((getAllByTestId('todo-item-complete-checkbox')[1] as HTMLInputElement).checked).toBe(false) /* eslint-disable-line prettier/prettier */
  expect((getAllByTestId('todo-item-complete-checkbox')[2] as HTMLInputElement).checked).toBe(false) /* eslint-disable-line prettier/prettier */
})
